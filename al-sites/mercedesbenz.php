...
<div class="text-center">
  <div style="max-width: 600px; margin: 0 auto;">
    <img src="../pics/mercedese.jpg" class="img-thumbnail img-fluid" alt="Car Image">
  </div>
</div>
      

  <form class="text-center formula rounded" method="post" action="mercedesbenz.php" id="rentalForm">
...
<div id="message">
  ...
  <script>
    ...
    function updateWeeklyPrice() {
      ...
      const price = weeks * 31300; // 21,000 Ft/hét áron
