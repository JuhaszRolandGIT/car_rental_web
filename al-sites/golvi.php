...
<div class="text-center">
  <div style="max-width: 600px; margin: 0 auto;">
    <img src="../pics/golf.jpg" class="img-thumbnail img-fluid" alt="Car Image">
  </div>
</div>
      

  <form class="text-center formula rounded" method="post" action="golvi.php" id="rentalForm">
...
<div id="message">
  ...
  <script>
    ...
    function updateSubmitButtonState() {
      ...
      const isFormValid = age >= 18 && birthdateInput.value !== "" && weekInput.value !== "" && (manualRadio.checked);
    ...
    function updateWeeklyPrice() {
      ...
      const price = weeks * 17500; // 21,000 Ft/hét áron
