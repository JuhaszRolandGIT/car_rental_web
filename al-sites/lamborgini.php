...
<div class="text-center">
  <div style="max-width: 600px; margin: 0 auto;">
    <img src="../pics/lamboe.jpg" class="img-thumbnail img-fluid" alt="Car Image">
  </div>
</div>
      

  <form class="text-center formula rounded" method="post" action="lamborgini.php" id="rentalForm">
...
<div id="message">
  ...
  <script>
    ...
    function updateWeeklyPrice() {
      ...
      const price = weeks * 77000; // 21,000 Ft/hét áron
